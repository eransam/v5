...
import { PopupOldFlocksComponent } from 'src/app/content/dashboard/ecommerce/popup-old-flocks/popup-old-flocks.component';
import { PopupCertificatesComponent } from 'src/app/content/dashboard/popup-certificates/popup-certificates.component';
import { PopupGrowerCardComponent } from 'src/app/content/dashboard/popup-grower-card/popup-grower-card.component';
import { PopupGrowerOtherAddrComponent } from 'src/app/content/dashboard/popup-grower-other-addr/popup-grower-other-addr.component';
import { PopupIzavonComponent } from 'src/app/content/dashboard/popup-izavon/popup-izavon.component';
import { PopupMonthlySummaryComponent } from 'src/app/content/dashboard/popup-monthly-summary/popup-monthly-summary.component';
import { PopupMoreInfoGrowerComponent } from 'src/app/content/dashboard/popup-more-info-grower/popup-more-info-grower.component';
import { PopupOldGrowerNameComponent } from 'src/app/content/dashboard/popup-old-grower-name/popup-old-grower-name.component';
import { PopupOldGrowerComponent } from 'src/app/content/dashboard/popup-old-grower/popup-old-grower.component';
import { PopupPartnersHodimComponent } from 'src/app/content/dashboard/popup-partners-hodim/popup-partners-hodim.component';
import { PopupPaymentComponent } from 'src/app/content/dashboard/popup-payment/popup-payment.component';
import { PopupPetemPartnersComponent } from 'src/app/content/dashboard/popup-petem-partners/popup-petem-partners.component';
import { PopupRavShnatiComponent } from 'src/app/content/dashboard/popup-rav-shnati/popup-rav-shnati.component';
import { MegadelSearchService } from 'src/app/services/MegadelSearch.service';
import { EnvironmentFrontService } from 'src/app/services/environment-front.service';
