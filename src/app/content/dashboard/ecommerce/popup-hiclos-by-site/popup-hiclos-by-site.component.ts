...
@Component({
  selector: 'app-popup-hiclos-by-site',
  templateUrl: './popup-hiclos-by-site.component.html',
  styleUrls: ['./popup-hiclos-by-site.component.css']
})
export class PopupHiclosBySiteComponent {
    userTypeID;
    certificateSum = 0;
